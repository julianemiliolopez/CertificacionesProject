...
class CertifCeroDias(models.Model):
    idd = models.AutoField(db_column='Idd', primary_key=True)  # Field name made lowercase.
    legajo = models.DecimalField(db_column='Legajo', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Certificaciones(models.Model):
    documento = models.DecimalField(db_column='Documento', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    legajo = models.DecimalField(db_column='Legajo', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Certificacionesht(models.Model):
    idd = models.AutoField(db_column='IDD', primary_key=True)  # Field name made lowercase.
    planilla = models.DecimalField(db_column='Planilla', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    documento = models.DecimalField(db_column='Documento', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    legajo = models.DecimalField(db_column='Legajo', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class CertificacionesAusenciasjustif(models.Model):
    idd = models.AutoField(db_column='Idd', primary_key=True)  # Field name made lowercase.
    documento = models.FloatField(db_column='Documento')  # Field name made lowercase.
...
class CertificacionesEstados(models.Model):
    ...
    prioridad = models.DecimalField(db_column='Prioridad', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class CertificacionesObservaciones(models.Model):
    idd = models.AutoField(db_column='Idd', primary_key=True)  # Field name made lowercase.
    planilla = models.DecimalField(db_column='Planilla', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class CertificacionesPedidos(models.Model):
    idd = models.AutoField(db_column='IDD', primary_key=True)  # Field name made lowercase.
    documento = models.DecimalField(db_column='Documento', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    apellido_nombre = models.CharField(db_column='Apellido_Nombre', max_length=40, blank=True, null=True)  # Field name made lowercase.
...
class CertificacionesServicios(models.Model):
    ...
    porc_invalidez = models.DecimalField(db_column='Porc Invalidez', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    observacion = models.CharField(db_column='Observacion', max_length=100, blank=True, null=True)  # Field name made lowercase.
    dias = models.DecimalField(db_column='Dias', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    cargo = models.ForeignKey('Categorias', models.DO_NOTHING, db_column='Cargo', blank=True, null=True)  # Field name made lowercase.
...
class Conceptos(models.Model):
    ...
    idd = models.AutoField(db_column='IDD', primary_key=True)  # Field name made lowercase.
    idd_concepto = models.DecimalField(db_column='idd_Concepto', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Dependencias(models.Model):
    idd = models.AutoField(db_column='Idd', primary_key=True)  # Field name made lowercase.
    codigo_dependencia = models.CharField(db_column='Codigo Dependencia', max_length=3)  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class DescuentosSalarioFamiliar(models.Model):
    idd = models.AutoField(db_column='Idd', primary_key=True)  # Field name made lowercase.
    nroorden = models.IntegerField(db_column='NroOrden')  # Field name made lowercase.
    documento = models.DecimalField(db_column='Documento', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    legajo = models.DecimalField(db_column='Legajo', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    empresa = models.CharField(db_column='Empresa', max_length=6)  # Field name made lowercase.
    importe_total = models.DecimalField(db_column='Importe Total', max_digits=10, decimal_places=5)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe_cuota = models.DecimalField(db_column='Importe Cuota', max_digits=10, decimal_places=5)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    total_cancelar = models.DecimalField(db_column='Total Cancelar', max_digits=10, decimal_places=5)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    porcentaje = models.DecimalField(db_column='Porcentaje', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    fecha_desde = models.DateTimeField(db_column='Fecha Desde', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    fecha_hasta = models.DateTimeField(db_column='Fecha Hasta', blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
...
class Legajos(models.Model):
    idd = models.AutoField(db_column='Idd', primary_key=True)  # Field name made lowercase.
    documento = models.DecimalField(db_column='Documento', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    idd_legajos = models.DecimalField(max_digits=10, decimal_places=5)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    legajo = models.DecimalField(db_column='Legajo', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    empresa = models.CharField(db_column='Empresa', max_length=6)  # Field name made lowercase.
    ...
    antiguedad = models.DecimalField(db_column='Antiguedad', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Liquidacion(models.Model):
    idd = models.AutoField(db_column='Idd', primary_key=True)  # Field name made lowercase.
    documento = models.DecimalField(db_column='Documento', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    idd_legajos = models.DecimalField(db_column='idd_Legajos', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    idd_concepto = models.DecimalField(db_column='idd_Concepto', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    orden = models.DecimalField(db_column='Orden', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    unidades = models.DecimalField(db_column='Unidades', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe = models.DecimalField(db_column='Importe', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    concepto1 = models.DecimalField(db_column='Concepto1', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    liq_horas = models.DecimalField(db_column='Liq_Horas', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    liq_escalas = models.DecimalField(db_column='Liq_Escalas', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    liq_cargo = models.DecimalField(db_column='Liq_Cargo', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    t2numeric = models.DecimalField(db_column='T2numeric', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    t3numeric = models.DecimalField(db_column='T3numeric', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Maestro(models.Model):
    ...
    cantidad_horas = models.DecimalField(db_column='Cantidad Horas', max_digits=10, decimal_places=5)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    antiguedad = models.DecimalField(db_column='Antiguedad', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    antiguedad_decreto = models.DecimalField(db_column='Antiguedad Decreto', max_digits=10, decimal_places=5)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    maternidad_total_dias = models.DecimalField(db_column='Maternidad Total Dias', max_digits=10, decimal_places=5)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    aporte_jubilatorio = models.DecimalField(db_column='Aporte Jubilatorio', max_digits=10, decimal_places=5)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    obra_social_fam_cargo = models.DecimalField(db_column='Obra Social Fam Cargo', max_digits=10, decimal_places=5)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    vacaciones_dias = models.DecimalField(db_column='Vacaciones Dias', max_digits=10, decimal_places=5)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    caja_complementaria = models.DecimalField(db_column='Caja Complementaria', max_digits=10, decimal_places=5)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    derecho_ocupacion = models.DecimalField(db_column='Derecho Ocupacion', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Parametros(models.Model):
    idd = models.AutoField(db_column='Idd', primary_key=True)  # Field name made lowercase.
    registro = models.DecimalField(db_column='Registro', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    idd_legajo = models.DecimalField(db_column='Idd_Legajo', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    idd_concepto = models.DecimalField(db_column='Idd_Concepto', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    valor_ind_prov = models.DecimalField(db_column='Valor Ind. Prov', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    valor_ind_nac = models.DecimalField(db_column='Valor Ind. Nac', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    nro_recibo = models.DecimalField(db_column='Nro_Recibo', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    nro_certificado = models.DecimalField(db_column='Nro_Certificado', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    topesalarial = models.DecimalField(db_column='TopeSalarial', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    sueldo_vital = models.DecimalField(db_column='Sueldo Vital', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    identidad = models.DecimalField(max_digits=10, decimal_places=5)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    art = models.DecimalField(db_column='ART', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    coeficiente_art = models.DecimalField(db_column='Coeficiente_art', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    tope_minimo_art = models.DecimalField(db_column='Tope_Minimo_art', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    tope_maximo_art = models.DecimalField(db_column='Tope_maximo_art', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Personas(models.Model):
    ...
    id_cuenta = models.DecimalField(max_digits=10, decimal_places=5)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    caja_de_ahorro = models.CharField(db_column='Caja de Ahorro', max_length=9, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters.
    ...
    aporte_solidario = models.DecimalField(db_column='Aporte Solidario', max_digits=10, decimal_places=5)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Tmpcpt(models.Model):
    ...
    importe1 = models.DecimalField(db_column='Importe1', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe2 = models.DecimalField(db_column='Importe2', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    importe = models.DecimalField(db_column='Importe', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Valorizaciones(models.Model):
    ...
    importe_bruto = models.DecimalField(max_digits=10, decimal_places=5)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe_liquido = models.DecimalField(max_digits=10, decimal_places=5)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Categorias(models.Model):
    ...
    descripcion = models.CharField(db_column='Descripcion', max_length=50, blank=True, null=True)  # Field name made lowercase.
    observaciones = models.CharField(db_column='Observaciones', max_length=200, blank=True, null=True)  # Field name made lowercase.
    secuencia = models.DecimalField(db_column='Secuencia', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    ...
    ubicacion = models.DecimalField(db_column='Ubicacion', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe1 = models.DecimalField(db_column='Importe1', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe2 = models.DecimalField(db_column='Importe2', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe3 = models.DecimalField(db_column='Importe3', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe4 = models.DecimalField(db_column='Importe4', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe5 = models.DecimalField(db_column='Importe5', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe6 = models.DecimalField(db_column='Importe6', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe7 = models.DecimalField(db_column='Importe7', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe8 = models.DecimalField(db_column='Importe8', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe9 = models.DecimalField(db_column='Importe9', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    importe10 = models.DecimalField(db_column='Importe10', max_digits=10, decimal_places=5)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    porc_asistencia = models.DecimalField(db_column='Porc. Asistencia', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. Field renamed to remove unsuitable characters. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
    escalanro = models.IntegerField(db_column='EscalaNro', blank=True, null=True)  # Field name made lowercase.
    horas = models.DecimalField(db_column='Horas', max_digits=10, decimal_places=5, blank=True, null=True)  # Field name made lowercase. max_digits and decimal_places have been guessed, as this database handles decimal fields as float
...
class Seguridad(models.Model):
    ...
    id_sector = models.DecimalField(max_digits=10, decimal_places=5)  # max_digits and decimal_places have been guessed, as this database handles decimal fields as float
