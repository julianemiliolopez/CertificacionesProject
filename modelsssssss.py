...
class SQLServerAuthGroup(models.Model):
...
class SQLServerAuthGroupPermissions(models.Model):
    id = models.BigAutoField(primary_key=True)
    group = models.ForeignKey(SQLServerAuthGroup, models.DO_NOTHING)
...
class SQLServerAuthPermission(models.Model):
...
class SQLServerAuthUser(models.Model):
...
class SQLServerAuthUserGroups(models.Model):
    id = models.BigAutoField(primary_key=True)
    user = models.ForeignKey(SQLServerAuthUser, models.DO_NOTHING)
    group = models.ForeignKey(SQLServerAuthGroup, models.DO_NOTHING)
...
class SQLServerAuthUserUserPermissions(models.Model):
    id = models.BigAutoField(primary_key=True)
    user = models.ForeignKey(SQLServerAuthUser, models.DO_NOTHING)
    permission = models.ForeignKey(SQLServerAuthPermission, models.DO_NOTHING)
...
class SQLServerDjangoAdminLog(models.Model):
